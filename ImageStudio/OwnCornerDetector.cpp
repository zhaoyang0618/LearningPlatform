...
static const char* myHarris_window = "My Harris corner detector";
static const char* myShiTomasi_window = "My Shi Tomasi corner detector";
...
void OwnCornerDetector::test(const char* imagefile)
{
